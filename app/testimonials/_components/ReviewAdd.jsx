...
const ReviewAdd = () => {
  ...
  return (
    <div>
      ...
      >
      Add<span className="hidden md:block"> Review</span> <SquarePlus className="md:w-5 md:h-5 w-4 h-4" />
      </button>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          <motion.div
            className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center  mx-4 sm:mx-0 pt-10 sm:pt-0 "
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          >
            ...
            >
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-2 sm:space-y-4 noscrollbar  overflow-y-auto flex-1 pr-1">
                <input
                ...
                <textarea
                  {...register("review", {
                    ...
                    minLength: {
                      value: 150,
                      message: "Review must be at least 150 characters",
                    },
                  })}
                ...
                />
                {errors.review && (
                  <p className="text-red-400 text-sm">{errors.review.message}</p>
                )}
                ...
                <div className="flex justify-end gap-3 pt-4">
                  ...
                  <button
                    type="submit"
                    disabled={!isValid || loading || rating === 0}
